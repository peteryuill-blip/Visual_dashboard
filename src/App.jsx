...
export default function App() {
  ...
  // ⚡ Bolt: Memoize the image click handler to prevent passing new function
  // references to Queue components on every render, enabling React.memo to work properly.
  // Expected impact: Eliminates unnecessary re-renders of the Queue component when state changes.
