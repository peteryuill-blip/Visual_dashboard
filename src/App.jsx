...
export default function App() {
  ...
  // ⚡ Bolt Optimization: Stabilized function reference using useCallback
  // Performance Impact: Prevents invalidation of React.memo in child list components by ensuring
  // this function pointer remains identical across parent re-renders.
