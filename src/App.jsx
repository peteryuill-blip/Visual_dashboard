...
export default function App() {
  ...
  // Memoized handlers to prevent unnecessary re-renders of Queue items
  ...
  const handleProcessBatch = useCallback(() => processBatch(imagesToRun), [imagesToRun]);
