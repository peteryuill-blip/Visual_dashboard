...
export default function App() {
  ...
  // Bolt Optimization: Stabilize the handleImageClick callback using useCallback.
  // This prevents invalidating React.memo in Queue's ImageRow components on every render.
