...
// ⚡ Bolt: Extract inline list items to a React.memo component.
// Expected impact: Prevents O(n) rendering cost when a single item's status updates.
// Only the items whose props actually change will be re-rendered.
