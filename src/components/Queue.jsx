...
// Performance Optimization: React.memo prevents massive re-renders of the entire list
// by skipping rendering for list items whose props (img and onImageClick) haven't changed.
