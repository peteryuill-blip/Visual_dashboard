...
// Performance optimization: Extract list items into a memoized component.
// This prevents the entire list from re-rendering when the parent component updates,
// significantly improving performance for large batches of images.
