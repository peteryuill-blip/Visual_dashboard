...
// ⚡ Bolt Optimization: Extracted inline component to React.memo
// Impact: Prevents O(n) re-renders of the entire list when only a single item's state changes.
// Reduces main thread blocking during large batch updates (e.g. 100+ images) by skipping render for unmodified items.
const QueueItem = React.memo(({ img, onImageClick }) => (
  <div
