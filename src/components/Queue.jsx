...
// Performance optimization: Extract pure utility functions from the render loop
...
// Performance optimization: Memoize list items to prevent full list re-rendering when one item changes
