...
// ⚡ Bolt: Extracted QueueItem and wrapped it in React.memo to prevent unnecessary re-renders.
// Expected impact: List items will now only render when their specific props change, rather than on every queue update, keeping the UI smooth with large batches.
