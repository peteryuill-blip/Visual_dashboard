...
// ⚡ Bolt Optimization: Extracted queue items to a React.memo component to prevent massive re-renders
// Performance Impact: Previously, any change to the parent Queue component (or when adding new images)
// would re-render every single list item. Now, items are O(1) render complexity unless their specific props change.
