...
// ⚡ Bolt Optimization:
// Extracted inline list component to React.memo to prevent O(n) re-renders
// when Queue state updates.
// Expected Impact: O(1) render time for existing items when new images are added.
